...
const MOCK_LINES = [
  {
    id: "1",
    title: "Thermal and Multispectral Imaging",
    description: "Desarrollo de algoritmos para detección, clasificación y seguimiento de objetos en imágenes térmicas y multiespectrales, con énfasis en visión en tiempo real.",
    tags: ["object-detection", "deep-learning", "real-time"],
    papers_count: 12,
    projects_count: 3,
  },
  {
    ...
    description: "Aplicaciones de visión computacional sobre imágenes satelitales y de drones para monitoreo ambiental, agricultura de precisión y análisis del territorio.",
    tags: ["remote-sensing", "segmentation", "uav", "agriculture"],
    papers_count: 8,
    projects_count: 2,
  },
  {
    ...
    description: "Sistemas de apoyo diagnóstico mediante segmentación de estructuras anatómicas y análisis automático de radiografías, resonancias y biopsias digitales.",
  ...
  },
  {
    ...
    description: "Técnicas de reconstrucción de escenas 3D, estimación monocular de profundidad y SLAM visual para robótica y vehículos autónomos.",
    tags: ["3d-reconstruction", "depth-estimation", "monocular"],
    papers_count: 5,
    projects_count: 1,
  },
...
const MOCK_MEMBERS = [
  { id: "1", name: "Hoover Rueda", role: "Director", avatar: null },
...
export async function getHomeSummary() {
  ...
  return {
    ...
    about: `Somos una comunidad apasionada por la visión por computador y la inteligencia 
    artificial, dedicada a fomentar el aprendizaje, la colaboración y la innovación 
    tecnológica. Nuestro grupo está conformado por estudiantes, profesionales y entusiastas 
    que comparten el objetivo de explorar y desarrollar soluciones avanzadas en el campo de 
    la visión artificial, desde el procesamiento de imágenes hasta el aprendizaje profundo y 
    la robótica.`,
  };
}
